...
namespace Nobi.UiRoundedCorners.Editor
{
    ...
    {
		private TriangleRoundedCorners script;

		private void OnEnable()
		{
			script = (TriangleRoundedCorners)target;
		}
		...
		public override void OnInspectorGUI()
		{
			...
			prop = serializedObject.FindProperty("corner0");
			EditorGUILayout.PropertyField(prop, new GUIContent("Corner0"));

			prop = serializedObject.FindProperty("corner1");
			EditorGUILayout.PropertyField(prop, new GUIContent("Corner1"));

			prop = serializedObject.FindProperty("corner2");
			EditorGUILayout.PropertyField(prop, new GUIContent("Corner2"));
